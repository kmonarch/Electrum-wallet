 ...
 5. `daemon.py` 文件中的 `def init_gui(self, config, plugins):`
	...
	```
	 ...
	 3. 在此方法中，程序会根据本地的路径来判断是否已存在钱包，如存在则打开，不存在则创建新钱包
		...
		14. 随后程序进入 `def create_keystore(self, seed, passphrase):`
		中进行一系列的判断，如果条件满足，则进行钱包的创建`base_wizard.py` ---> ` def create_wallet(self):`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyOTUyMzg3MSw2MDUwMTIzMzksNTQwNT
AzMzMwLC0xNjI4ODcyNDU4LC0xMDE1NzgyNTYsLTk5OTU5MTk3
LC05OTk1OTE5NywyMDEwODM3MzEwLC0yMjIyMDQ1MTEsLTEyND
YyNzgyMzUsLTE0MjAyNDE4MjksMjQyNjYzMjkxLDExODYwOTE2
NzksMTM0OTI1MTQ5MCwtMTE1MDYzMTM1OCwtMjEyMzMyNjc4MC
wtMTgwNTAyMzI0Niw1NzE0ODcwODMsMTU4MjgzMTYyNywyMDc1
NjQ5NjExXX0=
-->
...
5. `daemon.py` 文件中的 `def init_gui(self, config, plugins):`
	...
	```
	 ...
	 3. 在此方法中，程序会根据本地的路径来判断是否已存在钱包，如存在则打开，不存在则创建新钱包
        ...
        run_next(*out)
		```
		进而运行`base_wizard.py` 中的 `def request_passphrase(self, seed, opt_passphrase):`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjkyNTEzODY0LDU0MDUwMzMzMCwtMTYyOD
g3MjQ1OCwtMTAxNTc4MjU2LC05OTk1OTE5NywtOTk5NTkxOTcs
MjAxMDgzNzMxMCwtMjIyMjA0NTExLC0xMjQ2Mjc4MjM1LC0xND
IwMjQxODI5LDI0MjY2MzI5MSwxMTg2MDkxNjc5LDEzNDkyNTE0
OTAsLTExNTA2MzEzNTgsLTIxMjMzMjY3ODAsLTE4MDUwMjMyND
YsNTcxNDg3MDgzLDE1ODI4MzE2MjcsMjA3NTY0OTYxMSwxMDAw
MjYwOTIwXX0=
-->
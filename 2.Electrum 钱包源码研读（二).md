...
5. `daemon.py` 文件中的 `def init_gui(self, config, plugins):`
	...
	```
	 ...
	 3. 在此方法中，程序会根据本地的路径来判断是否已存在钱包，如存在则打开，不存在则创建新钱包
		...
		12. 此时程序跳转到  `installwizard.py` 文件中的 `def wizard_dialog(func):` 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk5OTU5MTk3LC05OTk1OTE5NywyMDEwOD
M3MzEwLC0yMjIyMDQ1MTEsLTEyNDYyNzgyMzUsLTE0MjAyNDE4
MjksMjQyNjYzMjkxLDExODYwOTE2NzksMTM0OTI1MTQ5MCwtMT

	...
	```
	 ...
	 3. 在此方法中，程序会根据本地的路径来判断是否已存在钱包，如存在则打开，不存在则创建新钱包
		...
		6. 此时程序会跳转到 `_init_.py` 文件中 执行
		 ...
		 9. 此后，程序跳转至`base_wizard.py` 中的 `def new(self):`方法，并在此方法中进行UI的初始化工作 

<!--stackedit_data:
eyJoaXN0b3J5IjpbNjM3NDQ1MDIzLDEzNDkyNTE0OTAsLTExNT
A2MzEzNTgsLTIxMjMzMjY3ODAsLTE4MDUwMjMyNDYsNTcxNDg3
MDgzLDE1ODI4MzE2MjcsMjA3NTY0OTYxMSwxMDAwMjYwOTIwLC
0xOTI2Mjc5ODE0LC0xNjY4NDM3NTU4LC01MDI2MzI2NSwtMjE4
MzI2NDYzLDEzNDIyMzE2NDcsMTQ2NTE0OTkwMl19
-->
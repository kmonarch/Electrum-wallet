	 ...
	 3. 在此方法中，程序会根据本地的路径来判断是否已存在钱包，如存在则打开，不存在则创建新钱包
		...
		6. 此时程序会跳转到 `_init_.py` 文件中 执行
		 ...
		 def on_wallet_type(self, choice):
	        ...
	        self.run(action)
		 ```  
		 10. 随后程序会执行 `def choose_keystore(self):`方法来让用户选择

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MjgzMDAwMDQsMTM0OTI1MTQ5MCwtMT
E1MDYzMTM1OCwtMjEyMzMyNjc4MCwtMTgwNTAyMzI0Niw1NzE0
ODcwODMsMTU4MjgzMTYyNywyMDc1NjQ5NjExLDEwMDAyNjA5Mj
AsLTE5MjYyNzk4MTQsLTE2Njg0Mzc1NTgsLTUwMjYzMjY1LC0y
MTgzMjY0NjMsMTM0MjIzMTY0NywxNDY1MTQ5OTAyXX0=
-->